...
<script type="text/javascript" src = "<%= request.getContextPath() %>/js/emp_validate.js"> 
</script>
<script language="javascript" src="<%=request.getContextPath()%>/js/data.js">
</script>
...
<table border="1" width="100%" cellpadding="5" cellspacing="0" bgcolor="F2F2F2">
	...
	<tr onMouseOver="changeColor(this,'white')" onMouseOut="changeColor(this,'F2F2F2')">
		...
		<td><INPUT TYPE="text" NAME="hiredate" onclick='popUpCalendar(this, this, "yyyy-mm-dd")' size="15" maxlength="15" readonly="true" onBlur="validateHiredate(this.value)"></td>
